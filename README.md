...
make.config specifies some compilation options. You will need to edit and modify this file according to your compiler. In particular, you will need to modify BLAS_LIB and BLAS_CFLAGS, which specify the BLAS library, and you will need to change them according to the library you are using.
The sample make.config included in this repository assumes the use of Intel OneApi 2024 (icx and icpxcompiler).
